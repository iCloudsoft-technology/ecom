...
const categories = [
    ...
    //                 {
    //                     name: "Paintings & Drawings",
    //                     url: "/fashionstyle/paintings-drawings",
    //                 },
    //                 {
    //                     name: "Sculptures & Molds",
    //                     url: "/fashionstyle/sculptures-molds",
    //                 },
    //                 {
    //                     name: "Antiques",
    //                     url: "/fashionstyle/antiques",
    //                 },
    //                 {
    //                     name: "Beading & Decorating",
    //                     url: "/fashionstyle/beading-decorating",
    //                 },
    //                 {
    //                     name: "Crafting",
    //                     url: "/fashionstyle/crafting",
    //                 },
    //                 {
    //                     name: "Knitting & Crochet",
    //                     url: "/fashionstyle/knitting-crochet",
    //                 },
    //                 {
    //                     name: "Collectibles",
    //                     url: "/fashionstyle/collectibles",
    //                 },
    //                 {
    //                     name: "Art Instruments",
    //                     url: "/fashionstyle/art-instruments",
    //                 },
    //                 {
    //                     name: "Art Accessories",
    //                     url: "/fashionstyle/art-accessories",
    //                 }
    //             ]
    ...
    //                     {
    //                         name: "LCD TV",
    //                         url: "/cellphones/tv-and-visual/lcd-tv",
    //                     }
    //                 ]
    //             }
    //         ]
